...
class NaverSearchApi : Thread() {
    ...
    companion object {
        var clientId = "EYOvSd046ngfoYNGtu7q" //애플리케이션 클라이언트 아이디값"
        var clientSecret = "bY3QkVIHo_" //애플리케이션 클라이언트 시크릿값"
        fun main() {
            ...
            val apiURL =
                "https://openapi.naver.com/v1/search/news?query=$text" // json 결과
